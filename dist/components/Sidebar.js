...
function create_each_block(ctx) {
  let show_if = !ctx[1].includes("[page]");
  let if_block_anchor;
  let current;
...
function create_fragment(ctx) {
  ...
  return {
    ...
    l(nodes) {
      ...
      t0 = $$7b66f1cf.claim_text(h2_nodes, "Get started");
    ...
    h() {
      $$7b66f1cf.attr(h2, "class", "m-2");
      $$7b66f1cf.attr(div, "class", "mr-8 border-r-2");
    },
    m(target, anchor) {
      $$7b66f1cf.insert_hydration(target, div, anchor);
      $$7b66f1cf.append_hydration(div, h2);
      $$7b66f1cf.append_hydration(h2, t0);
